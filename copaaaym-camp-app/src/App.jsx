...
function Home({ go, total }) {
  const c = useCountdown(new Date("2026-08-04T13:00:00+00:00").getTime());
  return (
    <div className="page">
      <div className="hero">
        ...
        <div className="hero-inner">
          ...
          <p className="hero-meta">
            ...
            Wednesday 4th – Saturday 8th August 2026
          </p>
...
/* ============================ SINGLE REGISTER ============================ */
const blank = { name: "", age: "", gender: "", email: "", phone: "", area: DEFAULT_AREA, district: "", assembly: "", allergy: "", emergency: "" };
...
function Register({ go, toast, refresh }) {
  ...
  const validate = () => {
    ...
    if (!f.emergency.trim()) x.emergency = "Enter an emergency contact (name & phone)";
  ...
  return (
    <div className="page form-page">
      ...
      <Tilt className="form-card" max={3}>
        ...
        <Field label="Emergency contact (name & phone)" req err={err.emergency}><input className="inp" value={f.emergency} onChange={set("emergency")} placeholder="e.g. Kofi Mensah - 0244 000 000" /></Field>
        ...
        <>
          ...
          <div className="panel">
            ...
            <div className="table-wrap">
              <table className="tbl">
                <thead><tr><th>Name</th><th>Age</th><th>Sex</th><th>Phone</th><th>Area</th><th>District</th><th>Allergy / medical</th><th>By</th><th>Status</th></tr></thead>
                <tbody>
                  {f.length === 0 && <tr><td colSpan={9} className="empty">No registrations yet. They appear here the moment a member signs up.</td></tr>}
                  {f.map((r) => (
                    <tr key={r.id}>
      ...
      <div className="pass-wrap">
        <div className="pass print-area">
          <div className="pass-top">
            ...
            <div><div className="pass-camp">Catalyst 2026</div><div className="pass-dates">Anagkazo, Mampong \u00b7 4\u20138 Aug 2026</div></div>
          </div>
